...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::resource('task-lists', TaskListsController::class)->only(['show', 'create', 'store', 'edit', 'update', 'destroy'])->parameter('task-lists', 'taskList');
    Route::resource('task-lists.tasks', TaskListTasksController::class)->only(['create', 'store'])->parameter('task-lists', 'taskList');
