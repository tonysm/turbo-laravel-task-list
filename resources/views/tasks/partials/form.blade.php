...
>
    ...
    <div class="mt-4 px-3 flex items-center justify-between native:mt-0 native:pl-0">
        ...
        @if ($task ?? false)
        <x-secondary-button data-bridge--delete-form-target="submit" data-bridge-title="{{ __('Are you sure you want to delete this task?') }}" form="{{ dom_id($task, 'delete_form') }}" type="submit">
